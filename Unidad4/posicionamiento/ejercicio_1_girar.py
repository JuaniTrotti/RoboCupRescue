...
def girar(rad):
    ...
    # Dependiendo del signo de rad cambiamos el sentido del giro
    if rad > 0:
    ...
    # En un loop ejecutamos el step() y vamos calculando cuánto giramos, si 
    # llegamos al ángulo deseado salimos del loop
    while step() != -1:
